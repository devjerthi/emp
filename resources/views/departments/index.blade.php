...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Departments <span class="badge badge-dark"></span> <a href="{{route('departments.create')}}" title="Add Title" class="float-right">Add Departments</a></h6>
    </div>
    <div class="card-body">
                ...
                <tr>
                    ...
                    <td>
                        <form action= "{{route('departments.destroy',$user->id)}}" method="Post">
                            <a class="btn btn-primary" href="{{route('departments.edit',$user->id)}}">Edit</a>
                                @csrf
                                @method('DELETE')
...
<!-- Page level plugins -->
<!--script src="http://demo.projectsplaza.com/empManage/public/lib/vendor/datatables/jquery.dataTables.min.js"></script>
<script src="http://demo.projectsplaza.com/empManage/public/lib/vendor/datatables/dataTables.bootstrap4.min.js"></script>
<!__ Page level custom scripts -->
<script src="http://demo.projectsplaza.com/empManage/public/lib/js/demo/datatables-demo.js"></script>
        </div>
        <!-- /.container-fluid -->
