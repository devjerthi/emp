...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Add Employee <a href="{{route('employe.create')}}" title="List Data" class="float-right"><i class="fa fa-arrow-left"></i></a></h6>
    </div>
    <div class="card-body">
            ...
            <form method="post" action="{{route('employe.store')}}" enctype="multipart/form-data">
              ...
              <tr>
                  ...
                  <tr>
                    ...
                    <tr>
                        <td colspan="3">
                        <a class="btn btn-success" href="{{route('employe.index')}}">Back</a>
                        </td>
                    </tr>
                </table>
            </form>
